...
|-----------------|---------------|-----------------|  
|name|**nvarchar(256)**|The name of the object. name is unique within a package for a specific object type. Is not nullable.|  
...
|description|**nvarchar(3072)**|A description of the action. description is set by the package author. Is not nullable.|  
...
|type_name|**nvarchar(256)**|The name for pred_source and pred_compare objects. Is nullable.|  
